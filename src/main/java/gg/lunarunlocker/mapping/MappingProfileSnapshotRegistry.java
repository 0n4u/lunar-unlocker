...
import gg.lunarunlocker.mapping.MappingMemberSnapshot;
import gg.lunarunlocker.mapping.MappingMethod;
import gg.lunarunlocker.utils.StringPair;
...
public class MappingProfileSnapshotRegistry {
    ...
    public static void X(MappingMethod mappingMethod) {
        if (!LunarUnlocker.INSTANCE.isMappingsRemapped() && !LunarUnlocker.INSTANCE.isForgeRemapInactive()) {
            return;
        }
