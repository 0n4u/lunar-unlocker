...
extends MemberNameRemapTable {
    ...
    protected void Qf() {
        if (LunarUnlocker.INSTANCE.isVanillaMinecraftPresent()) {
    ...
    protected void e() {
        this.t(MappedClasses.VJ, "getEntitiesWithinAABBForEntity", LunarUnlocker.INSTANCE.isVanillaMinecraftPresent() ? "getEntities" : "func_177414_a");
    }
    ...
    protected void Qr() {
        ...
        this.t(MappedClasses.Z, "removeEntity", LunarUnlocker.INSTANCE.isVanillaMinecraftPresent() ? "onEntityRemovedVanilla" : "onEntityRemoved");
    ...
    protected void u6() {
        ...
        this.t(MappedClasses.zc, "isOffsetPositionInLiquid", LunarUnlocker.INSTANCE.isVanillaMinecraftPresent() ? "isFree" : "func_70038_c");
        ...
        this.t(MappedClasses.zc, "setPositionAndRotation", LunarUnlocker.INSTANCE.isVanillaMinecraftPresent() ? "absMoveTo" : "func_70080_a");
    ...
    protected void ue() {
        ...
        if (LunarUnlocker.INSTANCE.isVanillaMinecraftPresent() || !LunarUnlocker.INSTANCE.isForgeAbsent()) {
    ...
    protected void QS() {
        this.b(MappedClasses.u4, "getSprite", "func_215288_a", LunarUnlocker.INSTANCE.isForgeAbsent());
    }
