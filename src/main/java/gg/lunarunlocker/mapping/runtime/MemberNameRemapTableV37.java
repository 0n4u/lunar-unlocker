...
import gg.lunarunlocker.mapping.runtime.MemberNameRemapTable;
...
extends MemberNameRemapTable {
    ...
    protected void H() {
        ...
        this.t(MappedClasses.VK, "func_82840_a", LunarUnlocker.INSTANCE.isVanillaMinecraftPresent() ? "getTooltipLines" : "m_41651_");
    ...
    protected void R3() {
        ...
        this.t(MappedClasses.zc, "setPositionAndRotation", LunarUnlocker.INSTANCE.isVanillaMinecraftPresent() ? "absMoveTo" : "m_19890_");
    ...
    protected void E() {
        this.t(MappedClasses.ls, "fogDensity", LunarUnlocker.INSTANCE.isVanillaMinecraftPresent() ? "setShaderFogStart" : "m_157445_");
    }
    ...
    protected void e() {
        this.t(MappedClasses.Fj, "func_196954_c", LunarUnlocker.INSTANCE.isVanillaMinecraftPresent() ? "getShape" : "m_60808_");
    }
    ...
    protected void RY() {
        ...
        this.t(MappedClasses.uQ, "func_243246_a", LunarUnlocker.INSTANCE.isVanillaMinecraftPresent() ? "drawShadow" : "m_92763_");
        this.t(MappedClasses.uQ, "func_243248_b", LunarUnlocker.INSTANCE.isVanillaMinecraftPresent() ? "draw" : "m_92889_");
    }
