...
import gg.lunarunlocker.asm.helper.DescUtils;
import gg.lunarunlocker.mapping.MappedClasses;
import gg.lunarunlocker.mapping.Mapping;
import gg.lunarunlocker.mapping.MappingMethodBuilder;
import gg.lunarunlocker.mapping.MappingProfileSnapshotRegistry;
import gg.lunarunlocker.mapping.NativeMappedMemberInvoker;
import gg.lunarunlocker.mapping.access.GeneratedAccessorFactory;
import gg.lunarunlocker.mapping.access.MethodInvoker;
import gg.lunarunlocker.mapping.runtime.MemberLookupSignature;
...
public class MappingMethod {
    ...
    public void initializeAccessor(Class<?> owner) {
        if ((LunarUnlocker.INSTANCE.isMappingsRemapped() || LunarUnlocker.INSTANCE.isForgeRemapInactive()) && !this.resolutionFailed) {
    ...
    public String getResolvedName() {
        if (LunarUnlocker.INSTANCE.isForgeRemapInactive()) {
    ...
    public MappingMethod register() {
        ...
        try {
            ...
            if (!this.skipAccessorGeneration && !LunarUnlocker.INSTANCE.isForgeRemapInactive()) {
